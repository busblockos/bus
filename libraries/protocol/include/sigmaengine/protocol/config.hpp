...
#define SIGMAENGINE_VERSION                                         ( version(0, 1, 516) )
...
#define SIGMAENGINE_INIT_PUBLIC_KEY_STR                             "BUS8AC92qZFLfzvZ5hQtL4L7ZdmbEMkj3otccobDGcSrRQjSY4fhG" // 5Kbn1PrneRnSYob5rToDmDmkZg5ZLND6ZQKYUQj7WvkAZAnup1W
#define SIGMAENGINE_CHAIN_ID                                        (fc::sha256::hash("bus_mainnet")) //(sigmaengine::protocol::chain_id_type())
#define SGT_SYMBOL                                                  (uint64_t(SIGMAENGINE_BLOCKCHAIN_PRECISION_DIGITS) | (uint64_t('B') << 8) | (uint64_t('U') << 16) | (uint64_t('S') << 24) )///< BUS with 8 digits of precision
#define SIGMAENGINE_ADDRESS_PREFIX                                  "BUS"
#define SIGMAENGINE_GENESIS_TIME                                    (fc::time_point_sec(1622176926))     // 20210528044206 GMT+9
